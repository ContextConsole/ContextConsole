...
Public Interface IInteractor
    ...
    Function AskInteger(ByVal prompt As String, ByVal defaultValue As Integer?) As Integer?
    Function AskLiteral(Of T)(ByVal prompt As String, ByVal convert As Func(Of String, T), ByVal defaultValue As T) As T
    Function AskDate(ByVal prompt As String, ByVal defaultValue As Date?) As Date?
    Function AskBoolean(ByVal prompt As String, ByVal defaultValue As Boolean?) As Boolean?
