properties { 
  ...
  $zipFileName = "Icm.ConsoleMvc." + $majorWithReleaseVersion + ".zip"
  ...
  $builds = @(
    @{Name = "Icm.ConsoleMvc"; TestsName = "Icm.ConsoleMvc.Tests"; Constants=""; FinalDir="Net40-Client"; NuGetDir = "net40-Client"; Framework="net-4.0"; Sign=$true}
  ...
  $mainBuildName = "Icm.ConsoleMvc"
  $nugetSpec = "Icm.ConsoleMvc.nuspec"
}
